...
<head>
    ...
    <link href="inserirALUNO.css" rel="stylesheet">
  </head>
</head>
<body>
   ...
   <div class="mb-3">
      <h1 >Cadastre o aluno</h1>
        ...
        <h5>MATRICULA:</h5> <input type="text" name="matricula" id="matricula" class="form-control"  ><br>
        ...
        require("conexao.php");
         ...
         ?>
           <select name="turma" id="turma" class="form-select form-select-lg mb-3" >
